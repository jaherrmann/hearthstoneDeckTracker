...
create TRIGGER stats_after_insert AFTER insert on decklist for each row BEGIN insert into stats (wins, losses, win_percentage, deck_id) values (0, 0, 0, new.id); END;
